...
def runILS(va):
    ...
    while itILS < maxILSIterations:
        while iterations < maxIterations and vBest != 0:
            ...
            vTempSolution, serviceSatis, energySatis = OB.CalculateSatisfaction(tempSolution)
    ...
    return vBest, serviceSatis, energySatis, tempSolution
...
if __name__ == '__main__':
    ...
    while itILS < maxILSIterations:
        while iterations < maxIterations and vBest != 0:
            tempSolution = NeighborSolution(copy.deepcopy(tempSolution))
            vTempSolution, *_ = OB.CalculateSatisfaction(tempSolution)
            if vTempSolution < vBest:
                vBest = vTempSolution
                tempSolution = copy.deepcopy(tempSolution)
            iterations += 1
